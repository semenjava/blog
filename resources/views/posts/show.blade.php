...
@section('title')
  @if($post)
    ...
    @if(!Auth::guest() && ($post->author_id == Auth::user()->id || Auth::user()->is_admin()))
      <button class="btn" style="float: right"><a href="{{ url('edit/'.$post->slug)}}">Edite post</a></button>
    @endif
  @else
    Post not found
  @endif
  ...
  @else
    <div class="panel-body">
      <form method="post" action="/comment/add">
        ...
        <input type="submit" name='post_comment' class="btn btn-success" value = "Publish"/>
      </form>
    </div>
  @endif
  <div>
